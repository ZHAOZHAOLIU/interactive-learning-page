...
Generated from [an engineering blog post](https://www.langchain.com/blog/improving-deep-agents-with-harness-engineering), in Chinese, in one pass:

[![Home view](assets/demo-home.png)](assets/demo-home.png)

<table>
<tr>
<td width="50%"><a href="assets/demo-module.png"><img src="assets/demo-module.png" alt="Module view"></a><br><sub><b>Module view</b> — intuition first, then diagram, analogy, misconception callout, comparison table, key takeaways, and a quick check.</sub></td>
<td width="50%"><a href="assets/demo-exam.png"><img src="assets/demo-exam.png" alt="Final exam"></a><br><sub><b>Final exam</b> — scored, with weak modules auto-listed and their unmastered prerequisites chained underneath.</sub></td>
</tr>
<tr>
<td width="50%"><a href="assets/demo-cheatsheet.png"><img src="assets/demo-cheatsheet.png" alt="Cheatsheet"></a><br><sub><b>Cheatsheet</b> — no prose, pure density. For the five minutes before an interview or exam.</sub></td>
<td width="50%"><a href="assets/demo-home-alt.png"><img src="assets/demo-home-alt.png" alt="A different source, a different visual direction"></a><br><sub><b>A different source</b> — the visual direction is derived per subject, not reused from a template.</sub></td>
</tr>
</table>
...
To pin the output language or your background explicitly:

```
Make an English study page from this Chinese paper — I'm prepping
for a systems design interview, ground the analogies in distributed systems
```
...
Two pages generated by this skill from real engineering blog posts, both in Chinese:
...
Download either file and open it in a browser — they're fully functional, including saved progress.
...
├── examples/                         Two complete generated pages
